...
{
  mpc_cleanup(n, parser1, parser2, parser3, parser4, parser5, parser6, parser7);
}
...
{
  return mpca_lang(flags, language, parser1, parser2, parser3, parser4, parser5, parser6, parser7);
}
